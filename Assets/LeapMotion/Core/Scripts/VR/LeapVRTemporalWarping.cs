...
namespace Leap.Unity {
  ...
  public class LeapVRTemporalWarping : MonoBehaviour {
    ...
    private const float DEFAULT_DEVICE_OFFSET_X_AXIS = 0f;
    ...
    public bool allowManualDeviceOffset {
      ...
      set {
        ...
        {
          deviceOffsetXAxis = DEFAULT_DEVICE_OFFSET_X_AXIS;
    ...
    public float deviceOffsetYAxis {
      ...
      [SerializeField]
      [Range(-0.5F, 0.5F)]
      private float deviceOffsetXAxis = DEFAULT_DEVICE_OFFSET_X_AXIS;
      public float _deviceOffsetXAxis
        {
          get
          {
              return _deviceOffsetXAxis;
          }
          set
          {
              _deviceOffsetXAxis = value;
          }
      }
    ...
    public bool TryGetWarpedTransform(WarpedAnchor anchor, out Vector3 rewoundPosition, out Quaternion rewoundRotation, long leapTime) {
      ...
      Vector3    deviceOffset = new Vector3(deviceOffsetXAxis, deviceOffsetYAxis, deviceOffsetZAxis).CompMul(this.transform.lossyScale);
